...
public:
        ...
        //бросок всех костей
		void throw_dices();
        void make_dice(int index,QPushButton* bt) {dices[index].shape_dice(bt);};
        ...
        //вернуть указатель на определенную кнопку
        QPushButton* diceButton(int i) {return dices[i].get_button();}
		friend class bot;
